...
2. Launch Docker, and in the base directory, run `docker-compose --env-file .config.env up -d`. This will launch the node with a public RPC reachable at http://orbit.aws.moonstruck.io:8449/  and a corresponding BlockScout explorer instance, viewable at http://orbit.aws.moonstruck.io/
